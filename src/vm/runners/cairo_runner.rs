...
mod tests {
    ...
    */
    ...
    fn write_output_from_preset_memory() {
        ...
        assert_eq!(stdout, String::from("1\n2\n"));
    }
    ...
    */
    ...
    fn end_run_proof_mode_insufficient_allocated_cells() {
        let program = load_program!(
            "../../../cairo_programs/proof_programs/fibonacci.json",
            Some("main")
        );
    ...
    fn run_from_entrypoint_custom_program_test() {
        let program = load_program!("../../../cairo_programs/example_program.json", None,);
        let mut cairo_runner = cairo_runner!(program);
    ...
    fn get_builtins_final_stack_range_check_builtin() {
        let program = load_program!(
            "../../../cairo_programs/assert_le_felt_hint.json",
            Some("main")
        );
        let mut runner = cairo_runner!(program);
        let mut vm = vm!();
